...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
        ...
        <h1><strong>Single Quote</strong></h1>

        <?php

          $singleQuoteId = $_GET['quote_id'];
          //query to get sessions order by course_ide
          $getQuotes = "SELECT * FROM `quotes` WHERE `quote_id` = '$singleQuoteId'";
          //run query
          ...
          ?>
             ...
             <h1><strong>What film: </strong><?php echo "$movieTitle";?></h1>
 ...
 <a class="btn btn-primary btn-lg"href="downloadSingle.php?quote_id=<?php echo $movieId ?>">Download List here</a>
